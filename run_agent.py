...
class AIAgent:
    ...
    def _max_tokens_param(self, value: int) -> dict:
        ...
        kwarg, which the upstream model rejects with a 400.  In particular,
        gpt-5.x aliases like "gpt-5.5-combos" reject 'max_tokens' regardless
        of which OpenAI-compatible gateway serves them.
        """
        if (
