...
def _select_update_branch(
    ...
    - Otherwise prefer the current branch when origin/<current_branch> exists.
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        # the stable branch remains `main`. (Fork customization — upstream's
        # apply path uses _resolve_update_branch(args), which defaults to main.)
        # An explicit --branch still wins, preserving upstream's --branch contract.
