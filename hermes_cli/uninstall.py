...
def _perform_uninstall(
    *,
    ...
    if not full_uninstall:
        ...
        if _is_windows():
            print(color("  irm https://raw.githubusercontent.com/Scorpion1221/hermes-agent/develop/scripts/install.ps1 | iex", Colors.DIM))
        else:
            print(color("  curl -fsSL https://raw.githubusercontent.com/Scorpion1221/hermes-agent/develop/scripts/install.sh | bash", Colors.DIM))
        print()
