...
# Configuration
REPO_URL_SSH="git@github.com:Scorpion1221/hermes-agent.git"
REPO_URL_HTTPS="https://github.com/Scorpion1221/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/Scorpion1221/hermes-agent/develop/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
