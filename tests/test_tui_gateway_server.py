...
def test_write_json_serializes_concurrent_writes():
    ...
    def _write(frame):
        # Bind a transport scoped to this worker.  Several earlier tests in
        # this large module intentionally leave async gateway work draining;
        # monkey-patching the module-global stdout lets those unrelated frames
        # race this assertion even though this transport's own lock is sound.
