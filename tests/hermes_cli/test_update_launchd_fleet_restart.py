...
class TestGetServicePidsScoping:
    def _wire(self, monkeypatch):
        monkeypatch.setattr(gw.subprocess, "run", lambda *a, **kw: _completed(stdout="PID\tStatus\tLabel\n"))
    ...
    def test_all_profiles_protects_renamed_live_service_from_kill_sweep(self, monkeypatch):
        self._wire(monkeypatch)
        monkeypatch.setattr(gw.subprocess, "run", lambda *a, **kw: _completed(
            stdout="PID\tStatus\tLabel\n300\t0\tai.hermes.gateway-retired\n400\t0\tother.app\n",
        ))
